...
mod tests {
    use crate::alignment::{
        best_residue, consensus, densities, entropies, entropy, order, percent_identity, res_count, to_freq_distrib,
